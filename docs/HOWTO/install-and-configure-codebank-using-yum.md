...
1. [senzingdata](https://github.com/richiebono/knowledge-base/blob/main/HOWTO/install-senzing-data.md#centos)
1. [senzingapi](https://github.com/richiebono/knowledge-base/blob/main/HOWTO/install-senzing-api.md#centos)
...
1. Synthesize environment variables.
    ...
    ```console
    export LD_LIBRARY_PATH=/opt/richiebono/g2/lib:$LD_LIBRARY_PATH
