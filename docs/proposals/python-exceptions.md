...
Improve the customer experience in Exception handling in the CodeBank Python SDK.

### Proposal 2 Overview

Currently a Python programmer using the
[CodeBank Python SDK](https://github.com/richiebono/g2-sdk-python/tree/main/src/senzing)
has a plethora of
[Exceptions](https://github.com/richiebono/g2-sdk-python/blob/main/src/richiebono/G2Exception.py)
that could be thrown by the underlying SDK.

When an Exception is thrown by the CodeBank Python SDK,
...
1. Encapsulates the severity in the underlying CodeBank Python SDK.
...
1. Doesn't break the existing application code written using CodeBank V2.
...
The approach facilitates "future-proofing" applications using the CodeBank Python API.

1. New "specific" Exceptions can be added to the CodeBank Python API without the applications
...
1. [Before](https://github.com/richiebono/redoer/blob/c3d3aeaf281d091d2ca370da1c5c56f54d736a66/redoer.py#L2061-L2083)
...
1. Message numbers have
   [ranges](https://github.com/richiebono/stream-loader/blob/30c9fe591137793c063152cee04c0478523d7357/stream-loader.py#L892-L908).
   ...
   Log message identifiers have the format `senzing-ppppnnnnt`, where:
    ...
    - "p" is the 4 digit [product identifier](https://github.com/richiebono/knowledge-base/blob/main/lists/senzing-product-ids.md)
...
List of [CodeBank Engine error codes](https://senzing.zendesk.com/hc/en-us/articles/360026678133-Engine-Error-codes)
...
### CodeBank 2.x G2Exception hierarchy
